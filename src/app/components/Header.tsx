    ...
    return (
        <header className="flex justify-between items-center py-6">
            <h2 className="h2">devfinder</h2>
                <button  className="flex items-center button-theme" onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}>
                    <span className={`theme mr-2 ${theme === 'dark' ? 'light-theme' : 'dark-theme'}`} >{theme === 'dark' ? 'Light'.toUpperCase() : 'Dark'.toUpperCase()} </span>
                    {theme === 'light' ? (
                        <svg className="cursor-pointer dark" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" className="light">
