    ...
    return (
        <section className="mt-6 bg-white rounded-lg p-4 dark:bg-very-dark-grey">
            ...
            <div className="mt-8 space-y-2 md:grid md:grid-cols-2">
                <button className={`flex items-center ${!user.location && 'opacity-50 cursor-auto'}`}>
                    ...
                    <p className={`ml-2 h6 ${user.location && 'hover:underline'}`}>{user.location ? user.location : 'Not available'}</p>
                </button>
                <button className={`flex items-center ${!user.blog && 'opacity-50 cursor-auto'}`}>
                    ...
                    <p className={`ml-2 h6 ${user.blog && 'hover:underline'} `}>{user.blog ? user.blog : 'Not available'}</p>
                </button>
