        ...
        <section className="mt-6 bg-white rounded-lg p-4 dark:bg-very-dark-grey">
            ...
            <div className="mt-8 space-y-2 md:grid md:grid-cols-2">
                <button className="flex items-center">
                    ...
                    <p className={`ml-2 h6 ${user.location && 'hover:underline'} ${!user.location && 'opacity-50 cursor-auto'}`}>{user.location ? user.location : 'Not available'}</p>
                </button>
                <button className="flex items-center">
                    ...
                    <p className={`ml-2 h6 ${user.blog && 'hover:underline' } ${!user.blog && 'opacity-50 cursor-auto'}`}>{user.blog ? user.blog : 'Not available'}</p>
                </button>
                <button className={`flex items-center ${!user.twitter_username && 'opacity-50 cursor-auto'}`}>
                ...
                <button className={`flex items-center ${!user.company && 'opacity-50 cursor-auto'}`}>
                    <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className={`ml-2 h6 ${user.company && 'hover:underline'} ${!user.company && 'opacity-50 cursor-auto'}`}>{user.company ? user.company : 'Not available'}</p>
                </button>
            </div>
        </section>
