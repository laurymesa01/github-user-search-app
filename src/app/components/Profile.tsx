    ...
    return (
        <section className="mt-6 bg-white rounded-lg p-4">
            <div>
                ...
                <h3>{user.name}</h3>
                <a>@{user.login}</a>
                <p>{user.bio ? user.bio : 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros.'}</p>
            </div>
            <div>
                <p className="p"></p>
            </div>
            ...
            <div className="mt-8">
                ...
                <div className="flex items-center">
                    ...
                    <p className="ml-2">{user.twitter_username ? user.twitter_username : 'Not available'}</p>
                </div>
                <div className="flex items-center">
                    <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="ml-2">{user.company}</p>
                </div>
            </div>
        </section>
