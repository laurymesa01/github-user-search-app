        ...
        <section className="mt-6 bg-white rounded-lg p-4 dark:bg-very-dark-grey">
            ...
            <div className="mt-8 space-y-2 md:grid md:grid-cols-2">
                <div className="flex items-center">
                    ...
                    <p className="ml-2 h6">{user.location}</p>
                </div>
                <div className="flex items-center">
                    ...
                    <p className="ml-2 h6">{user.blog}</p>
                </div>
                <div className="flex items-center">
                    ...
                    <p className="ml-2 h6">{user.twitter_username ? user.twitter_username : 'Not available'}</p>
                </div>
                <div className="flex items-center">
                    <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="ml-2 h6">{user.company}</p>
                </div>
            </div>
        </section>
